<?php
    ...
    class AuthController{
        ...
        public function login(Request $request): JsonResponse
        {
            ...
            //return $this->sendHttpStatusCode('TESTE', 200, $request->email);
            ...
            if (Auth::attempt($request->only('email', 'password'))) {
                ...
                return $this->getBearerToken($credentials['oauthClientId'], $credentials['secret'], $request->email, $request->password);
            }
        ...
        private function sendHttpStatusCode(int $status, $message=null, $body=null): JsonResponse
        {
            ...
            if(!is_null($message)){ $params['message'] = $message; }
        ...
        private function getBearerToken($oauthClientId, $secret, $email, $password): JsonResponse
        {
